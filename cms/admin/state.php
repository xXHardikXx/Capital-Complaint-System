                ...
                <div class="row align-items-center">
                    <div class="col-md-12">
                        <div class="page-header-title">
                            <h5 class="m-b-10">Kathmandu Municipalities</h5>
                        </div>
                        <ul class="breadcrumb">
                            <li class="breadcrumb-item"><a href="dashboard.php"><i class="feather icon-home"></i></a></li>
                            <li class="breadcrumb-item"><a href="state.php">Nagarpalika</a></li>
...
<?php } ?>
                                ...
                                <form method="post" name="Category">
                                    ...
                                    <div class="form-group">
                                        <label for="exampleInputEmail1">Municipalites</label>
                                       <input type="text" placeholder="Select Your Nagarpalika"  name="state" class="form-control" required>
                ...
                <div class="card">
                    <div class="card-header">
                        <h5>Manage Municipalities Of Kathmandu</h5>
                    </div>
