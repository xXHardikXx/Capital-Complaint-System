...
$_SESSION['msg']="Municipalites info Updated !!";
                ...
                <div class="row align-items-center">
                    <div class="col-md-12">
                        <div class="page-header-title">
                            <h5 class="m-b-10">Edit Municipalites</h5>
                        </div>
                        <ul class="breadcrumb">
                            <li class="breadcrumb-item"><a href="dashboard.php"><i class="feather icon-home"></i></a></li>
                            <li class="breadcrumb-item"><a href="edit-state.php">Municipalites</a></li>
            ...
            <div class="col-sm-12">
                <div class="card">
                    <div class="card-header">
                        <h5>Edit Municipalites</h5>
                    </div>
                    <div class="card-body">
                        <h5>View and Edit Municipalites</h5>
                        <hr>
                        <div class="row">
                            <div class="col-md-6">
...
?>
                                    ...
                                    <div class="form-group">
                                        <label for="exampleInputEmail1">Municipalites Name</label>
