...
<head>
    <title>CCS ||Register Complaint</title>
                            ...
                            <div class="col-md-10">
                                ...
                                <form method="post" name="complaint" enctype="multipart/form-data">
                                     ...
                                     <div class="form-group">
                                        <label for="exampleInputEmail1">Complaint Category Type</label>
...
?>
                                     ...
                                     <div class="form-group">
                                        <label for="exampleInputEmail1">Sub Category Type</label>
...
<option value="">Select Subcategory</option>
                                     ...
                                     <div class="form-group">
                                        <label for="exampleInputEmail1">Complaint Urgency</label>
                                        <select name="complaintype" class="form-control" required="">
                <option value="Normal Complaint">Normal Complaint</option>
                  
<option value="Medium Complaint">Medium Complaint</option>
<option value="Hard Complaint">Hard Complaint</option>
<option value="Risky Complaint">Risky Complaint</option>
...
<option value="">Select Your Nagarpalika</option>
...
?>
                                     ...
                                     <div class="form-group">
                                        <label for="exampleInputEmail1">Things To Be Noted While Solving The Complaint</label>
